package com.ming.shortlink.gateway.com.ming.shortlink.gateway.filter;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.ming.shortlink.gateway.com.ming.shortlink.gateway.config.Config;
import com.ming.shortlink.gateway.com.ming.shortlink.gateway.dto.GatewayErrorResult;
...
import static com.ming.shortlink.gateway.com.ming.shortlink.gateway.common.constant.RedisKeyConstant.USER_LOGIN_KEY;
...
public class TokenValidateGatewayFilterFactory extends AbstractGatewayFilterFactory<Config> {
    ...
    private boolean isPathInWhiteList(String requestPath, String requestMethod, List<String>whitePathList) {
        return (!CollectionUtils.isEmpty(whitePathList) && whitePathList.stream()
