...
import com.ming.shortlink.project.dto.req.RecycleBinRemoveReqDTO;
...
import com.ming.shortlink.project.service.RecycleBinService;
import lombok.RequiredArgsConstructor;
import org.springframework.data.redis.core.StringRedisTemplate;
import org.springframework.stereotype.Service;

import static com.ming.shortlink.project.common.constant.RedisKeyConstant.GOTO_IS_NULL_SHORT_LINK_KEY;
import static com.ming.shortlink.project.common.constant.RedisKeyConstant.GOTO_SHORT_LINK_KEY;
...
public class RecycleBinServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements RecycleBinService {
    ...
    public void saveRecycleBin(RecycleBinSaveReqDTO requestParam) {
        ...
        stringRedisTemplate.delete(String.format(
                        GOTO_SHORT_LINK_KEY, requestParam.getFullShortUrl()));
    }
