...
import com.ming.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        // 基础访问数据
        LinkAccessStatsDO pvUvUipStatsByShortLink = linkAccessLogMapper.findPvUvUipStatsByShortLink(requestParam);
        // 基础访问详情
        ...
        HashMap<String, Object> findUvTypeShortLink = linkAccessLogMapper.findUvTypeCntByShortLink(requestParam);
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        // 基础访问数据
        LinkAccessStatsDO pvUvUipStatsByGroup = linkAccessLogMapper.findPvUvUipStatsByGroup(requestParam);
        // 基础访问详情
        List<ShortLinkStatsAccessDailyRespDTO> daily = new ArrayList<>();
        List<String> rangeDates = DateUtil.rangeToList(DateUtil.parse(requestParam.getStartDate()), DateUtil.parse(requestParam.getEndDate()), DateField.DAY_OF_MONTH)
                .stream().map(DateUtil::formatDate).toList();
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        ...
        ShortLinkStatsAccessRecordReqDTO linkAccessLogsDOIPage = linkAccessLogMapper.selectPage(requestParam, queryWrapper);
        ...
        List<HashMap<String, Object>> uvTYpeList = linkAccessLogMapper.selectUvTypeByUsers(requestParam.getGid(), requestParam.getFullShortUrl(), requestParam.getStartDate(), requestParam.getEndDate(), userAccessLogsList);
